    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="sp_log.php">Already a member?click here to Login</a>
          </li>
      <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="login.php">Sign-Up as Customer</a>
          </li>
		  <li class="nav-item">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Space Provider Sign Up</h2>
      ...
      <div class="row">
        ...
        <div class="col-lg-12 text-center">
            <form action="sp_reg_db.php" method="post" name="form">
            <div class="row">
