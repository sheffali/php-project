    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Thankyou for feedback</h2>
...
$q31="use feedback1";
mysqli_query($conn,$q31) or die("not used 1");
$q32="insert into sp_feeback values('f_id','$name','$cno','$rating','$satis','$comment')";
mysqli_query($conn,$q32) or die("not used 2");
//echo"selected";
?>
