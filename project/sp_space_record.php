    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">FILL IN THIS FORM TO REQUEST YOUR SPACE</h2>
      ...
      <div class="row">
        ...
        <div class="col-lg-12 text-center">
          <form id="customersignup" name="signup" action="sp_space.php" novalidate="novalidate" method="post">
            <div class="row">
              <div class="col-lg-6 text-center">
			  <div class="form-group">
			  <h5><p class="text-warning">Address:</p>
                  <input class="form-control" id="address" name="address" type="text" placeholder="Your address *" required="required" data-validation-required-message="Please enter your email address.">
