    ...
    <div class="container">
      ...
      <div class="collapse navbar-collapse" id="navbarResponsive">
        <ul class="navbar-nav text-uppercase ml-auto">
          ...
          <li class="nav-item">
            <a class="nav-link js-scroll-trigger" href="login.php">Not a member?click here to Sign up</a>
          </li>
      <li class="nav-item">
    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">Customer Log In</h2>
      ...
      <div class="row">
        ...
        <div class="col-lg-12 text-center">
          <form action="cust_login_db.php" method="post" name="form">
            <div class="row">
