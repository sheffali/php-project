    ...
    <div class="container">
      <div class="row">
        <div class="col-lg-12 text-center">
          <h2 class="section-heading text-uppercase">You have been registered.</h2>
          <!--<h3 class="section-subheading text-muted">Your Basic Info</h3>-->
        </div>
      </div>

     <!-- <form action="thankyou.html" method="post" name="form">-->
      <form action="cust_log.php">
	  <br>
	  <br>
	  <br>
	  <br>
		...
		<center>
		 <div id="success"></div>
                <button id="sendMessageButton" class="btn btn-primary btn-xl text-uppercase" type="submit">click here to login</button>
              </div>
			  </center>
        </form>
		<footer>
...
$cno=$_POST['user_contact'];
$pass1 = bin2hex($pass);

/*$q1='create database if not exists customer';
mysqli_query($conn,$q1) or die('not connected');
echo"created";*/
$q2='use customer';
mysqli_query($conn,$q2)or die('not using');
//echo"using";
$q4="insert into cust_reg values('cust_id','$name','$email','$pass1','$cno')";
